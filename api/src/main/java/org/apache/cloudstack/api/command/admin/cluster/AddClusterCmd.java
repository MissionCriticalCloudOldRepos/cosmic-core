...
public class AddClusterCmd extends BaseCmd {
  ...
  @Parameter(name = ApiConstants.HYPERVISOR,
      ...
      required = true,
      description = "hypervisor type of the cluster: XenServer,KVM,Simulator,Ovm3")
  ...
  public void execute() {
    try {
      ...
      final ListResponse<ClusterResponse> response = new ListResponse<ClusterResponse>();
      final List<ClusterResponse> clusterResponses = new ArrayList<ClusterResponse>();
