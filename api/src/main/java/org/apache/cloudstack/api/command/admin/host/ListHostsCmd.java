...
public class ListHostsCmd extends BaseListCmd {
  ...
  @Parameter(name = ApiConstants.HYPERVISOR, type = CommandType.STRING, description = "hypervisor type of host: XenServer,KVM,Simulator")
  ...
  public EnumSet<HostDetails> getDetails() throws InvalidParameterValueException {
    ...
    if (viewDetails == null || viewDetails.size() <= 0) {
      ...
      try {
        final ArrayList<HostDetails> dc = new ArrayList<HostDetails>();
  ...
  public void execute() {
    ...
    if (getVirtualMachineId() == null) {
      ...
      final List<HostResponse> hostResponses = new ArrayList<HostResponse>();
