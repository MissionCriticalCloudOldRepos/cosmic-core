...
public class Upgrade501to502 implements DbUpgrade {

  private static final String PREVIOUS_VERSION = "5.0.1";
  private static final String NEXT_VERSION = "5.0.2";
  private static final String SCHEMA_SCRIPT = "db/schema-501to502.sql";
  private static final String SCHEMA_CLEANUP_SCRIPT = "db/schema-501to502-cleanup.sql";

  final static Logger s_logger = Logger.getLogger(Upgrade501to502.class);
