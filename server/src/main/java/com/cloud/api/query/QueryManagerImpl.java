...
public class QueryManagerImpl extends ManagerBase implements QueryService, Configurable {
  ...
  public ListResponse<UserResponse> searchForUsers(ListUsersCmd cmd) throws PermissionDeniedException {
    ...
    final ListResponse<UserResponse> response = new ListResponse<UserResponse>();
    final List<UserResponse> userResponses = ViewResponseHelper.createUserResponse(CallContext.current().getCallingAccount().getDomainId(),
  ...
  private Pair<List<UserAccountJoinVO>, Integer> searchForUsersInternal(ListUsersCmd cmd) throws PermissionDeniedException {
    ...
    if (id != null && id == 1) {
      ...
      final List<UserAccountJoinVO> emptyList = new ArrayList<UserAccountJoinVO>();
  ...
  public ListResponse<EventResponse> searchForEvents(ListEventsCmd cmd) {
    ...
    final ListResponse<EventResponse> response = new ListResponse<EventResponse>();
  ...
  private Pair<List<EventJoinVO>, Integer> searchForEventsInternal(ListEventsCmd cmd) {
    ...
    if (entryTime != null && duration != null) {
      ...
      // me!!
      /*
       * if (entryTime <= duration) { throw new InvalidParameterValueException (
       * "Entry time must be greater than duration"); } Calendar calMin = Calendar.getInstance(); Calendar calMax =
       * Calendar.getInstance(); calMin.add(Calendar.SECOND, -entryTime); calMax.add(Calendar.SECOND, -duration); Date
       * minTime = calMin.getTime(); Date maxTime = calMax.getTime();
       *
       * sc.setParameters("state", com.cloud.event.Event.State.Completed); sc.setParameters("startId", 0);
       * sc.setParameters("createDate", minTime, maxTime); List<EventJoinVO> startedEvents =
       * _eventJoinDao.searchAllEvents(sc, searchFilter); List<EventJoinVO> pendingEvents = new
       * ArrayList<EventJoinVO>(); for (EventVO event : startedEvents) { EventVO completedEvent =
       * _eventDao.findCompletedEvent(event.getId()); if (completedEvent == null) { pendingEvents.add(event); } } return
       * pendingEvents;
       */
    } else {
  ...
  public ListResponse<ResourceTagResponse> listTags(ListTagsCmd cmd) {
    ...
    final ListResponse<ResourceTagResponse> response = new ListResponse<ResourceTagResponse>();
  ...
  public ListResponse<InstanceGroupResponse> searchForVmGroups(ListVMGroupsCmd cmd) {
    ...
    final ListResponse<InstanceGroupResponse> response = new ListResponse<InstanceGroupResponse>();
  ...
  public ListResponse<UserVmResponse> searchForUserVMs(ListVMsCmd cmd) {
    ...
    final ListResponse<UserVmResponse> response = new ListResponse<UserVmResponse>();
  ...
  public ListResponse<SecurityGroupResponse> searchForSecurityGroups(ListSecurityGroupsCmd cmd) {
    ...
    final ListResponse<SecurityGroupResponse> response = new ListResponse<SecurityGroupResponse>();
  ...
  public ListResponse<DomainRouterResponse> searchForRouters(ListRoutersCmd cmd) {
    final Pair<List<DomainRouterJoinVO>, Integer> result = searchForRoutersInternal(cmd, cmd.getId(), cmd.getRouterName(), cmd.getState(), cmd.getZoneId(), cmd.getPodId(),
        cmd.getClusterId(), cmd.getHostId(),
        cmd.getKeyword(), cmd.getNetworkId(), cmd.getVpcId(), cmd.getForVpc(), cmd.getRole(), cmd.getVersion());
    final ListResponse<DomainRouterResponse> response = new ListResponse<DomainRouterResponse>();
  ...
  public ListResponse<DomainRouterResponse> searchForInternalLbVms(ListInternalLBVMsCmd cmd) {
    final Pair<List<DomainRouterJoinVO>, Integer> result = searchForRoutersInternal(cmd, cmd.getId(), cmd.getRouterName(), cmd.getState(), cmd.getZoneId(), cmd.getPodId(), null,
        cmd.getHostId(), cmd.getKeyword(),
  ...
  public ListResponse<ProjectResponse> listProjects(ListProjectsCmd cmd) {
    ...
    final ListResponse<ProjectResponse> response = new ListResponse<ProjectResponse>();
  ...
  public ListResponse<ProjectInvitationResponse> listProjectInvitations(ListProjectInvitationsCmd cmd) {
    ...
    final ListResponse<ProjectInvitationResponse> response = new ListResponse<ProjectInvitationResponse>();
    final List<ProjectInvitationResponse> projectInvitationResponses = ViewResponseHelper.createProjectInvitationResponse(
        invites.first().toArray(new ProjectInvitationJoinVO[invites.first().size()]));
  ...
  public ListResponse<ProjectAccountResponse> listProjectAccounts(ListProjectAccountsCmd cmd) {
    ...
    final ListResponse<ProjectAccountResponse> response = new ListResponse<ProjectAccountResponse>();
    final List<ProjectAccountResponse> projectResponses = ViewResponseHelper.createProjectAccountResponse(
        projectAccounts.first().toArray(new ProjectAccountJoinVO[projectAccounts.first().size()]));
  ...
  public ListResponse<HostResponse> searchForServers(ListHostsCmd cmd) {
    ...
    final ListResponse<HostResponse> response = new ListResponse<HostResponse>();
  ...
  public ListResponse<VolumeResponse> searchForVolumes(ListVolumesCmd cmd) {
    ...
    final ListResponse<VolumeResponse> response = new ListResponse<VolumeResponse>();
  ...
  public ListResponse<DomainResponse> searchForDomains(ListDomainsCmd cmd) {
    ...
    final ListResponse<DomainResponse> response = new ListResponse<DomainResponse>();
  ...
  public ListResponse<AccountResponse> searchForAccounts(ListAccountsCmd cmd) {
    ...
    final ListResponse<AccountResponse> response = new ListResponse<AccountResponse>();
  ...
  public ListResponse<AsyncJobResponse> searchForAsyncJobs(ListAsyncJobsCmd cmd) {
    ...
    final ListResponse<AsyncJobResponse> response = new ListResponse<AsyncJobResponse>();
  ...
  public ListResponse<StoragePoolResponse> searchForStoragePools(ListStoragePoolsCmd cmd) {
    ...
    final ListResponse<StoragePoolResponse> response = new ListResponse<StoragePoolResponse>();
  ...
  public ListResponse<StorageTagResponse> searchForStorageTags(ListStorageTagsCmd cmd) {
    ...
    final ListResponse<StorageTagResponse> response = new ListResponse<StorageTagResponse>();
  ...
  public ListResponse<HostTagResponse> searchForHostTags(ListHostTagsCmd cmd) {
    ...
    final ListResponse<HostTagResponse> response = new ListResponse<HostTagResponse>();
  ...
  public ListResponse<ImageStoreResponse> searchForImageStores(ListImageStoresCmd cmd) {
    ...
    final ListResponse<ImageStoreResponse> response = new ListResponse<ImageStoreResponse>();
  ...
  public ListResponse<DiskOfferingResponse> searchForDiskOfferings(ListDiskOfferingsCmd cmd) {
    ...
    final ListResponse<DiskOfferingResponse> response = new ListResponse<DiskOfferingResponse>();
    final List<DiskOfferingResponse> offeringResponses = ViewResponseHelper.createDiskOfferingResponse(result.first().toArray(new DiskOfferingJoinVO[result.first().size()]));
  ...
  public ListResponse<ServiceOfferingResponse> searchForServiceOfferings(ListServiceOfferingsCmd cmd) {
    ...
    result.first();
    final ListResponse<ServiceOfferingResponse> response = new ListResponse<ServiceOfferingResponse>();
    final List<ServiceOfferingResponse> offeringResponses = ViewResponseHelper.createServiceOfferingResponse(
        result.first().toArray(new ServiceOfferingJoinVO[result.first().size()]));
    response.setResponses(offeringResponses, result.second());
    return response;
  }
  ...
  private Pair<List<ServiceOfferingJoinVO>, Integer> searchForServiceOfferingsInternal(ListServiceOfferingsCmd cmd) {
    ...
    if (_accountMgr.isNormalUser(caller.getId()) || _accountMgr.isDomainAdmin(caller.getId())
      ...
      if (isRecursive) { // domain + all sub-domains
        ...
        // find all domain Id up to root domain for this account
        final List<Long> domainIds = new ArrayList<Long>();
  ...
  public ListResponse<ZoneResponse> listDataCenters(ListZonesCmd cmd) {
    ...
    final ListResponse<ZoneResponse> response = new ListResponse<ZoneResponse>();
    ...
    final List<ZoneResponse> dcResponses = ViewResponseHelper.createDataCenterResponse(respView, cmd.getShowCapacities(),
    ...
    if (id != null) {
      ...
      if (account != null) {
        if (available != null && Boolean.FALSE.equals(available)) {
          final Set<Long> dcIds = new HashSet<Long>(); // data centers with
          // at least one VM
          // running
  ...
  private List<Long> removeDedicatedZoneNotSuitabe(List<Long> domainIds) {
    ...
    final List<Long> dedicatedZoneIds = new ArrayList<Long>();
  ...
  public ListResponse<TemplateResponse> listTemplates(ListTemplatesCmd cmd) {
    ...
    final ListResponse<TemplateResponse> response = new ListResponse<TemplateResponse>();
  ...
  private Pair<List<TemplateJoinVO>, Integer> searchForTemplatesInternal(ListTemplatesCmd cmd) {
    ...
    final List<Long> permittedAccountIds = new ArrayList<Long>();
    final Ternary<Long, Boolean, ListProjectResourcesCriteria> domainIdRecursiveListProject = new Ternary<Long, Boolean, ListProjectResourcesCriteria>(
        cmd.getDomainId(), cmd.isRecursive(), null);
    _accountMgr.buildACLSearchParameters(caller, id, cmd.getAccountName(), cmd.getProjectId(), permittedAccountIds,
        domainIdRecursiveListProject, listAll, false);
    final ListProjectResourcesCriteria listProjectResourcesCriteria = domainIdRecursiveListProject.third();
    final List<Account> permittedAccounts = new ArrayList<Account>();
  ...
  private Pair<List<TemplateJoinVO>, Integer> searchForTemplatesInternal(Long templateId, String name,
    ...
    if (templateId != null) {
      ...
      final List<Long> relatedDomainIds = new ArrayList<Long>();
      final List<Long> permittedAccountIds = new ArrayList<Long>();
      if (!permittedAccounts.isEmpty()) {
  ...
  public ListResponse<AffinityGroupResponse> searchForAffinityGroups(ListAffinityGroupsCmd cmd) {
    ...
    final ListResponse<AffinityGroupResponse> response = new ListResponse<AffinityGroupResponse>();
  ...
  public Pair<List<AffinityGroupJoinVO>, Integer> searchForAffinityGroupsInternal(ListAffinityGroupsCmd cmd) {
    ...
    final List<Long> permittedAccounts = new ArrayList<Long>();
    final Ternary<Long, Boolean, ListProjectResourcesCriteria> ternary = new Ternary<Long, Boolean, ListProjectResourcesCriteria>(domainId, isRecursive, null);
    ...
    if (!permittedAccounts.isEmpty()) {
      ...
      if (domainId != null) {
        final SearchCriteria<AffinityGroupJoinVO> scDomain = buildAffinityGroupSearchCriteria(null, isRecursive, new ArrayList<Long>(), listProjectResourcesCriteria,
  ...
  private List<AffinityGroupJoinVO> listDomainLevelAffinityGroups(SearchCriteria<AffinityGroupJoinVO> sc, Filter searchFilter, long domainId) {
    final List<Long> affinityGroupIds = new ArrayList<Long>();
  ...
  public List<ResourceDetailResponse> listResourceDetails(ListResourceDetailsCmd cmd) {
    ...
    final List<ResourceDetailResponse> responseList = new ArrayList<ResourceDetailResponse>();
