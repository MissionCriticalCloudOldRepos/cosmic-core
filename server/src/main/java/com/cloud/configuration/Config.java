...
public enum Config {
  ...
  SystemVMDefaultHypervisor("Advanced",
      ...
      null,
      "Hypervisor type used to create system vm, valid values are: XenServer, KVM, VirtualBox, Parralels, Any",
      null),
  ...
  HypervisorList(
      ...
      String.class,
      "hypervisor.list",
      HypervisorType.KVM + "," + HypervisorType.XenServer + "," + HypervisorType.Ovm3,
